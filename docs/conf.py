# -*- coding: utf-8 -*-
#
# nti.app.client_preferences documentation build configuration file, created by
...
rqmt = pkg_resources.require('nti.app.client_preferences')[0]
...
project = u'nti.app.client_preferences'
...
extlinks = {
    'issue': ('https://github.com/NextThought/nti.app.client_preferences/issues/%s',
              'issue #'),
    'pr': ('https://github.com/NextThought/nti.app.client_preferences/pull/%s',
           'pull request #')}
